          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div className="flex flex-wrap items-center gap-6">
              ...
              <div className="relative group min-w-[160px]">
                <label className="absolute -top-2 left-3 px-2 bg-gray-800 text-xs font-medium text-gray-400">
                  Sort by
                </label>
                <select
                  value={sortBy}
                  onChange={(e) => setSortBy(e.target.value as SortKey)}
                  className="w-full px-4 py-3 bg-gray-900/50 text-white rounded-xl border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent backdrop-blur-sm appearance-none hover:bg-gray-700/50 transition-colors text-sm"
                >
