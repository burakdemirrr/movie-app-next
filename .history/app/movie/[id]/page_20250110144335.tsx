  ...
  if (isLoading) {
    return (
      <div className="animate-pulse">
        <div className="relative h-[70vh] w-full bg-gray-700" />
        <div className="container mx-auto px-4 py-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="relative h-[600px] bg-gray-700 rounded-lg" />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
          {movie.credits.cast.slice(0, 6).map((actor: CastMember) => (
            ...
            >
              ...
              <div className="p-4">
                <p className="font-semibold text-white mb-1 hover:text-blue-400 transition-colors">
                  {actor.name}
                </p>
